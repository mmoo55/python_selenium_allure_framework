...
@ddt
class LoginTestDDTWriteExcel(TestBase):
    ...
    @unpack
    def test_login_write_excel(self, numero_fila, username, password):
        ...
        try:
            ...
            FuncionesExcel().escribir_datos(self.archivo_excel, "LOGIN", int(numero_fila), "OK")
        except Exception as e:
            print("Error: ", e)
            FuncionesExcel().escribir_datos(self.archivo_excel, "LOGIN", int(numero_fila), "Error")
            raise TypeError(e)